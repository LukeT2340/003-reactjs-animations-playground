...
const CursorImageBlurEffect = () => {
  useEffect(() => {
    ...
    class SVGImageFilterEffect {
      ...
      constructor(DOM_el, options) {
        ...
        this.DOM.feDisplacementMapEl =
          this.DOM.el.querySelector("feDisplacementMap")
      ...
      render() {
        ...
        this.imgValues.imgTransforms.x = lerp(
          ...
          map(
            ...
            0,
            winsize.width,
            this.options.valuesFromTo.transform.x[0],
            this.options.valuesFromTo.transform.x[1]
          ),
        ...
        this.imgValues.imgTransforms.y = lerp(
          ...
          map(
            ...
            0,
            winsize.height,
            this.options.valuesFromTo.transform.y[0],
            this.options.valuesFromTo.transform.y[1]
          ),
          this.options.amt.transform
        )
        this.imgValues.imgTransforms.rz = lerp(
          ...
          map(
            ...
            0,
            winsize.width,
            this.options.valuesFromTo.transform.rz[0],
            this.options.valuesFromTo.transform.rz[1]
          ),
          this.options.amt.transform
        )
        ...
        this.DOM.feDisplacementMapEl.scale.baseVal =
          this.imgValues.displacementScale
        cachedCursor = cursor
  ...
  return (
    <>
      <div className='content w-[40vw] mx-auto'>
...
export default CursorImageBlurEffect
