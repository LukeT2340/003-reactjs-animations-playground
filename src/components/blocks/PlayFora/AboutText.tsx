...
const AboutText: React.FC = () => {
	...
	useEffect(() => {
		const handleScroll = debounce(() => {
			...
			setHasAnimatedTwo(scrollY > 850)
			setHasAnimatedThree(scrollY > 750)
		}, 0)
	...
	return (
		<div className="absolute left-1/2 translate-y-[150px] top-1/2 text-left">
			<div>
				<div className="block-copy max-w-[600px]">
					<motion.div
						initial={{ y: 0 }}
