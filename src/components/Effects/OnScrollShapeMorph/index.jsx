  ...
  return (
    <section>
      <div className='frame'>
        ...
        <a className='frame__back' href='https://tympanus.net/codrops/?p=74333'>
          Back to the article
        </a>
        <a
          className='frame__prev'
          href='https://tympanus.net/Development/PixelGooeyTooltip'
        >
          Previous demo
        </a>
      </div>
          ...
          <div className='content__img-wrap'>
            <div className='content__img content__img--1'>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/1.jpg)",
                }}
              ></div>
            </div>
          </div>
          ...
          <div className='content__img-wrap'>
            <div className='content__img content__img--1'>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/4.jpg)",
                }}
              ></div>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/3.jpg)",
                }}
              ></div>
            </div>
          </div>
          ...
          <div className='content__img-wrap'>
            <div className='content__img content__img--1'>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/5.jpg)",
                }}
              ></div>
              <div
                className='content__img-inner content__img-inner--hidden'
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/6.jpg)",
                }}
              ></div>
            </div>
          </div>
        ...
        <div id='item-3' className='content'>
          <div className='content__img-wrap'>
            <div className='content__img content__img--2'>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/7.jpg)",
                }}
              ></div>
              <div
                className='content__img-inner content__img-inner--hidden'
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/8.jpg)",
                }}
              ></div>
            </div>
          </div>
          <p className='content__text content__text--left'>
            ...
            <span className='content__text-tiny'>
              Do you ever dream of a dream so real it makes you question
              reality? What is reality? Do you question it? Turn off the light
              switch. Does it turn off? Question right now: is it a dream? You
              always wake up once you realize it's a dream. So, don't wake up.
              Realize it's a dream. That's how you enter the real world.
            </span>
          </p>
        </div>
          ...
          <div className='content__img-wrap'>
            <div className='content__img content__img--4'>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/9.jpg)",
                }}
              ></div>
              <div
                className='content__img-inner content__img-inner--hidden'
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/10.jpg)",
                }}
              ></div>
            </div>
          </div>
          ...
          <div className='content__img-wrap'>
            <div className='content__img content__img--5'>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/16.jpg)",
                }}
              ></div>
              <div
                className='content__img-inner content__img-inner--hidden'
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/15.jpg)",
                }}
              ></div>
            </div>
          </div>
          ...
          <div className='content__img-wrap'>
            <div className='content__img content__img--6'>
              <div
                ...
                style={{
                  backgroundImage:
                    "url(/assets/images/OnScrollShapeMorph/17.jpg)",
                }}
              ></div>
            </div>
          </div>
      ...
      <div className='content'>
        <h2 className='content__title'>More you might like</h2>
        <div className='card-wrap'>
          <div className='card'>
            <a
              ...
              style={{
                backgroundImage:
                  "url(https://tympanus.net/codrops/wp-content/uploads/2023/08/OnScrollColumns.jpg)",
              }}
            ></a>
            <p className='card__title'>
              <a href='https://tympanus.net/Development/OnScrollColumnsRows/'>
          ...
          <div className='card'>
            <a
              ...
              style={{
                backgroundImage:
                  "url(https://tympanus.net/codrops/wp-content/uploads/2023/08/onscroll3dgrid.jpg)",
              }}
            ></a>
            <p className='card__title'>
              <a href='http://tympanus.net/Development/Scroll3DGrid/'>
          ...
          <div className='card'>
            <a
              ...
              style={{
                backgroundImage:
                  "url(https://tympanus.net/codrops/wp-content/uploads/2023/07/onscrollfilter_feat-2.jpg)",
              }}
            ></a>
            <p className='card__title'>
              <a href='http://tympanus.net/Development/OnScrollFilter/'>
